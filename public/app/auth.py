...
def criar_token(data: dict) -> str:
    payload = data.copy()
    # JWT exige que "sub" seja string (RFC 7519) — o python-jose valida isso
    # de forma incondicional em jwt.decode() e rejeita qualquer token onde
    # "sub" tenha sido salvo como número.
    if "sub" in payload:
